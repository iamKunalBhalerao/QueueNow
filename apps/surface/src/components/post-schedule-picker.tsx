...
import { getScheduledDateTime } from "@/lib/schedule-post";

const PostSchedulePicker = ({
  setScheduledAt,
}: {
  ...
  async function handleScheduleUpdate() {
    const scheduledAt = await getScheduledDateTime({
      date: date!,
  ...
  return (
    <div>
      ...
      <p
        ...
        role="region"
      >
        Schedule your post to reach your audience at the perfect time. Select a
        date and time that works best for you, and we'll take care of the rest!
      </p>
    </div>
  );
};

export default PostSchedulePicker;
