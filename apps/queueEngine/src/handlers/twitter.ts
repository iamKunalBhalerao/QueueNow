 ...
 */
export async function handleTwitterPost(postId: string, userId: string, platformAccountId: string) {
  ...
  console.log(`[Twitter Handler] Processing post ${postId} for user ${userId} on account ${platformAccountId}`);
