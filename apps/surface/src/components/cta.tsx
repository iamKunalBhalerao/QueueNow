...
const CTA = () => {
  return (
    <div className="px-0 py-16 sm:px-6">
      <div className="mx-auto max-w-5xl overflow-hidden bg-linear-to-br from-indigo-500 via-40% via-indigo-500 to-purple-300 px-10 py-14 shadow-indigo-200 sm:rounded-xl sm:shadow-lg dark:shadow-indigo-600/50">
